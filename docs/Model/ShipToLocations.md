...
------------ | ------------- | ------------- | -------------
**regionExcluded** | [**\macropage\SDKs\ebay\rest\browse\Model\ShipToRegion[]**](ShipToRegion.md) | An array of containers that express the large geographical regions, countries, state/provinces, or special locations within a country where the seller is not willing to ship to. | [optional]
