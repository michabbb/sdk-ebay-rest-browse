...
class ItemSummaryApi
{
    ...
    protected function searchRequest($aspectFilter = null, $categoryIds = null, $charityIds = null, $epid = null, $fieldgroups = null, $filter = null, $gtin = null, $limit = null, $offset = null, $q = null, $sort = null)
    {
        ...
        if ($aspectFilter !== null) {
            $queryParams['aspect_filter'] = ObjectSerializer::toQueryValue($aspectFilter);
        }
        // query params
        if ($categoryIds !== null) {
            $queryParams['category_ids'] = ObjectSerializer::toQueryValue($categoryIds);
        }
        // query params
        if ($charityIds !== null) {
            $queryParams['charity_ids'] = ObjectSerializer::toQueryValue($charityIds);
        }
        // query params
        if ($epid !== null) {
