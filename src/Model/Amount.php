...
class Amount implements ModelInterface, ArrayAccess
{
     ...
     * Sets value
     *
     * @param string|null $value The dollar value of the currency specified in the currency field. The value of currency defaults to the standard currency used by the country of the eBay site offering the item.
     *
     * @return $this
     */
