...
class AspectDistribution implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'aspectValueDistributions' => '\macropage\SDKs\ebay\rest\browse\Model\AspectValueDistribution[]',
    ...
    {
        $this->container['aspectValueDistributions'] = isset($data['aspectValueDistributions']) ? $data['aspectValueDistributions'] : null;
        $this->container['localizedAspectName'] = isset($data['localizedAspectName']) ? $data['localizedAspectName'] : null;
    }
     ...
     *
     * @return \macropage\SDKs\ebay\rest\browse\Model\AspectValueDistribution[]|null
     */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\AspectValueDistribution[]|null $aspectValueDistributions An array of containers for the various values of the aspect and the match count and a HATEOAS reference ( refinementHref) for this aspect.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $localizedAspectName Name of an aspect, such as Brand, Color, etc.
     *
     * @return $this
     */
