...
/**
 * AspectFilter Class Doc Comment
 *
 * @category Class
 * @description This is the type that defines the fields for the aspect filter.
 * @package  macropage\SDKs\ebay\rest\browse
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AspectFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AspectFilter';
    ...
    protected static $openAPITypes = [
        'categoryId' => 'string',
        'filters' => '\macropage\SDKs\ebay\rest\browse\Model\FilterField[]'
    ];
     ...
     * Sets categoryId
     *
     * @param string|null $categoryId The ID of the category. This limits the aspects filtering to this category.
     *
     * @return $this
     */
     ...
     * Gets filters
     *
     * @return \macropage\SDKs\ebay\rest\browse\Model\FilterField[]|null
     */
     ...
     * Sets filters
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\FilterField[]|null $filters This query parameter supports multiple field filters that can be used to limit/customize the result set. For details and examples for all the filters, see Buy API Field Filters.
     *
     * @return $this
     */
