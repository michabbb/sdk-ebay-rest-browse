...
class AspectValueDistribution implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['localizedAspectValue'] = isset($data['localizedAspectValue']) ? $data['localizedAspectValue'] : null;
     ...
     *
     * @param string|null $localizedAspectValue The value of an aspect. For example, Red is a value for the aspect Color.
     *
     * @return $this
     */
     ...
     * Sets matchCount
     *
     * @param int|null $matchCount The number of items with this aspect.
     *
     * @return $this
     */
     ...
     * Sets refinementHref
     *
     * @param string|null $refinementHref A HATEOAS reference for this aspect.
     *
     * @return $this
     */
