...
class BuyingOptionDistribution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['buyingOption'] = $data['buyingOption'] ?? null;
     ...
     * Sets buyingOption
     *
     * @param string|null $buyingOption The container that returns the buying option type. This will be AUCTION or FIXED_PRICE or both. For details, see <a href=\"/api-docs/buy/browse/resources/item_summary/methods/search#response.itemSummaries.buyingOptions\">buyingOptions</a>.
     *
     * @return self
     */
