...
class BuyingOptionDistribution implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['buyingOption'] = isset($data['buyingOption']) ? $data['buyingOption'] : null;
        $this->container['matchCount'] = isset($data['matchCount']) ? $data['matchCount'] : null;
        $this->container['refinementHref'] = isset($data['refinementHref']) ? $data['refinementHref'] : null;
    }
    ...
    {
        return $this->container['buyingOption'];
    }

    /**
     * Sets buyingOption
     *
     * @param string|null $buyingOption Container that returns the buying option type. This will be AUCTION or FIXED_PRICE or both. For details, see buyingOptions.
     *
     * @return $this
     */
    public function setBuyingOption($buyingOption)
    {
        $this->container['buyingOption'] = $buyingOption;
     ...
     * Sets matchCount
     *
     * @param int|null $matchCount The number of items having this buying option.
     *
     * @return $this
     */
     ...
     * Sets refinementHref
     *
     * @param string|null $refinementHref The HATEOAS reference for this buying option.
     *
     * @return $this
     */
