...
class Category implements ModelInterface, ArrayAccess
{
     ...
     * Sets categoryId
     *
     * @param string|null $categoryId The unique identifier of the primary item category of the item, as well as the secondary item category if item was listed in two categories.
     *
     * @return $this
     */
