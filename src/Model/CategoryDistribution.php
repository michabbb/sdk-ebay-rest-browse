...
class CategoryDistribution implements ModelInterface, ArrayAccess
{
     ...
     * Sets categoryId
     *
     * @param string|null $categoryId The identifier of the category.
     *
     * @return $this
     */
     ...
     * Sets categoryName
     *
     * @param string|null $categoryName The name of the category, such as Baby &amp; Toddler Clothing.
     *
     * @return $this
     */
     ...
     * Sets matchCount
     *
     * @param int|null $matchCount The number of items in this category.
     *
     * @return $this
     */
     ...
     * Sets refinementHref
     *
     * @param string|null $refinementHref The HATEOAS reference of this category.
     *
     * @return $this
     */
