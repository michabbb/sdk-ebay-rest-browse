 ...
 * @link     https://openapi-generator.tech
 */
class CompatibilityPayload implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'compatibilityProperties' => '\macropage\SDKs\ebay\rest\browse\Model\AttributeNameValue[]'
    ];
    ...
    {
        $this->container['compatibilityProperties'] = isset($data['compatibilityProperties']) ? $data['compatibilityProperties'] : null;
    }
     ...
     *
     * @return \macropage\SDKs\ebay\rest\browse\Model\AttributeNameValue[]|null
     */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\AttributeNameValue[]|null $compatibilityProperties An array of attribute name/value pairs used to define a specific product. For example: If you wanted to specify a specific car, one of the name/value pairs would be &quot;name&quot; : &quot;Year&quot;, &quot;value&quot; : &quot;2019&quot; For a list of the attributes required for Cars and Trucks and Motorcycles see Required Attributes.
     *
     * @return $this
     */
