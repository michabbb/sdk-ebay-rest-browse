...
class CompatibilityPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\AttributeNameValue[]|null $compatibilityProperties An array of attribute name/value pairs used to define a specific product. For example: If you wanted to specify a specific car, one of the name/value pairs would be <br /><code>\"name\" : \"Year\", <br />\"value\" : \"2019\"</code>  <p> For a list of the attributes required for cars and trucks and motorcycles see <a href=\"/api-docs/buy/static/api-browse.html#Check\">Check compatibility</a> in the Buy Integration Guide.</p>
     *
     * @return self
     */
