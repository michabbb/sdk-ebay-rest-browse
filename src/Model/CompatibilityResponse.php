...
class CompatibilityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['compatibilityStatus'] = $data['compatibilityStatus'] ?? null;
