...
/**
 * DeliveryOptionsEnum Class Doc Comment
 *
 * @category Class
 * @description The type that defines the values that represent how the item can be delivered. Code so that your app gracefully handles any future changes to this list. Code so that your app gracefully handles any future changes to this list.
 * @package  macropage\SDKs\ebay\rest\browse
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DeliveryOptionsEnum
{
     ...
     */
    const SHIP_TO_HOME = 'SHIP_TO_HOME';
    const SELLER_ARRANGED_LOCAL_PICKUP = 'SELLER_ARRANGED_LOCAL_PICKUP';
    const IN_STORE_PICKUP = 'IN_STORE_PICKUP';
    const PICKUP_DROP_OFF = 'PICKUP_DROP_OFF';
    const DIGITAL_DELIVERY = 'DIGITAL_DELIVERY';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::SHIP_TO_HOME,
            self::SELLER_ARRANGED_LOCAL_PICKUP,
            self::IN_STORE_PICKUP,
            self::PICKUP_DROP_OFF,
