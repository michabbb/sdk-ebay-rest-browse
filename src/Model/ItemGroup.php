...
class ItemGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['commonDescriptions'] = $data['commonDescriptions'] ?? null;
     ...
     * Sets items
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\Item[]|null $items An array of containers for all the item variation details, excluding the description.
     *
     * @return self
     */
