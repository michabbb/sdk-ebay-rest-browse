...
class ItemLocationImpl implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets addressLine2
     *
     * @param string|null $addressLine2 The second line of the street address. This field may contain such values as an apartment or suite number.
     *
     * @return self
     */
     ...
     * Sets postalCode
     *
     * @param string|null $postalCode The postal code (or zip code in US) where the item is located. Sellers set a postal code (or zip code in US) for items when they are listed. The postal code is used for calculating proximity searches. It is anonymized when returned in <b>itemLocation.postalCode</b> via the API.
     *
     * @return self
     */
     ...
     *
     * @param string|null $stateOrProvince The state or province in which the item is located.
     *
     * @return self
     */
