...
class Price implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'convertedFromCurrency' => '\macropage\SDKs\ebay\rest\browse\Model\CurrencyCodeEnum',
        'convertedFromValue' => 'string',
        'currency' => '\macropage\SDKs\ebay\rest\browse\Model\CurrencyCodeEnum',
        'value' => 'string'
    ];
     ...
     *
     * @return \macropage\SDKs\ebay\rest\browse\Model\CurrencyCodeEnum|null
     */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\CurrencyCodeEnum|null $convertedFromCurrency convertedFromCurrency
     *
     * @return $this
     */
     ...
     *
     * @param string|null $convertedFromValue The monetary amount before any conversion is performed, in the currency specified by the convertedFromCurrency field. This value is the pre-conversion amount. The value field contains the converted amount of this value, in the currency specified by the currency field.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\CurrencyCodeEnum|null $currency currency
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string|null $value The dollar value of the currency specified in the currency field. The value of currency defaults to the standard currency used by the country of the eBay site offering the item. If currency conversion/localization was performed, this is the post-conversion amount. Default: The currency of the user's country.
     *
     * @return $this
     */
