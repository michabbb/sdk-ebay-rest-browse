...
class Refinement implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['aspectDistributions'] = isset($data['aspectDistributions']) ? $data['aspectDistributions'] : null;
        $this->container['buyingOptionDistributions'] = isset($data['buyingOptionDistributions']) ? $data['buyingOptionDistributions'] : null;
        $this->container['categoryDistributions'] = isset($data['categoryDistributions']) ? $data['categoryDistributions'] : null;
        $this->container['conditionDistributions'] = isset($data['conditionDistributions']) ? $data['conditionDistributions'] : null;
        $this->container['dominantCategoryId'] = isset($data['dominantCategoryId']) ? $data['dominantCategoryId'] : null;
    }
     ...
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\AspectDistribution[]|null $aspectDistributions A array of containers for the all the aspect refinements.
     *
     * @return $this
     */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\BuyingOptionDistribution[]|null $buyingOptionDistributions A array of containers for the all the buying option refinements.
     *
     * @return $this
     */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\CategoryDistribution[]|null $categoryDistributions A array of containers for the all the category refinements.
     *
     * @return $this
     */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\ConditionDistribution[]|null $conditionDistributions A array of containers for the all the condition refinements.
     *
     * @return $this
     */
