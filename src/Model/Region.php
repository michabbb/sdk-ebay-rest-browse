...
class Region implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets regionName
     *
     * @param string|null $regionName A localized text string that indicates the name of the region. Taxes are generally charged at the state/province level or at the country level in the case of VAT tax.
     *
     * @return self
     */
