...
/**
 * RegionTypeEnum Class Doc Comment
 *
 * @category Class
 * @description An enumerated type for the values that represent geographic regions. Code so that your app gracefully handles any future changes to this list. Code so that your app gracefully handles any future changes to this list.
 * @package  macropage\SDKs\ebay\rest\browse
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RegionTypeEnum
{
     ...
     */
    const COUNTRY_REGION = 'COUNTRY_REGION';
    const STATE_OR_PROVINCE = 'STATE_OR_PROVINCE';
    const COUNTRY = 'COUNTRY';
    const WORLD_REGION = 'WORLD_REGION';
