 ...
 * @link     https://openapi-generator.tech
 */
class SellerDetail implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'sellerLegalInfo' => '\macropage\SDKs\ebay\rest\browse\Model\SellerLegalInfo',
        'username' => 'string'
    ];
    ...
    protected static $setters = [
        'feedbackPercentage' => 'setFeedbackPercentage',
        'feedbackScore' => 'setFeedbackScore',
        'sellerAccountType' => 'setSellerAccountType',
        'sellerLegalInfo' => 'setSellerLegalInfo',
    ...
    protected static $getters = [
        ...
        'sellerAccountType' => 'getSellerAccountType',
        'sellerLegalInfo' => 'getSellerLegalInfo',
    ...
    {
        $this->container['feedbackPercentage'] = isset($data['feedbackPercentage']) ? $data['feedbackPercentage'] : null;
        $this->container['feedbackScore'] = isset($data['feedbackScore']) ? $data['feedbackScore'] : null;
        $this->container['sellerAccountType'] = isset($data['sellerAccountType']) ? $data['sellerAccountType'] : null;
        $this->container['sellerLegalInfo'] = isset($data['sellerLegalInfo']) ? $data['sellerLegalInfo'] : null;
    ...
    /**
     * Gets feedbackPercentage
     *
     * @return string|null
     */
    public function getFeedbackPercentage()
    {
        return $this->container['feedbackPercentage'];
    }

    /**
     * Sets feedbackPercentage
     *
     * @param string|null $feedbackPercentage The percentage of the total positive feedback.
     *
     * @return $this
     */
    public function setFeedbackPercentage($feedbackPercentage)
    {
        $this->container['feedbackPercentage'] = $feedbackPercentage;
    ...
    {
        return $this->container['feedbackScore'];
    }

    /**
     * Sets feedbackScore
     *
     * @param int|null $feedbackScore The feedback score of the seller. This value is based on the ratings from eBay members that bought items from this seller.
     *
     * @return $this
     */
    public function setFeedbackScore($feedbackScore)
    {
        $this->container['feedbackScore'] = $feedbackScore;

        return $this;
    }

    /**
     * Gets sellerAccountType
     *
     * @return string|null
     */
    public function getSellerAccountType()
    {
        return $this->container['sellerAccountType'];
    }

    /**
     * Sets sellerAccountType
     *
     * @param string|null $sellerAccountType Indicates if the seller is a business or an individual. This is determined when the seller registers with eBay. If they register for a business account, this value will be BUSINESS. If they register for a private account, this value will be INDIVIDUAL. This designation is required by the tax laws in some countries. This field is returned only on the following sites. EBAY_AT&nbsp;&nbsp;&nbsp;EBAY_BE&nbsp;&nbsp;&nbsp;EBAY_CH&nbsp;&nbsp;&nbsp;EBAY_DE&nbsp;&nbsp;&nbsp;EBAY_ES&nbsp;&nbsp;&nbsp;EBAY_FR&nbsp;&nbsp;&nbsp;EBAY_GB&nbsp;&nbsp;&nbsp;EBAY_IE&nbsp;&nbsp;&nbsp;EBAY_IT&nbsp;&nbsp;&nbsp;EBAY_PL Valid values: BUSINESS INDIVIDUALCode so that your app gracefully handles any future changes to this list.
     *
     * @return $this
     */
    public function setSellerAccountType($sellerAccountType)
    {
        $this->container['sellerAccountType'] = $sellerAccountType;

        return $this;
    }

    /**
     * Gets sellerLegalInfo
     *
     * @return \macropage\SDKs\ebay\rest\browse\Model\SellerLegalInfo|null
     */
    public function getSellerLegalInfo()
    {
        return $this->container['sellerLegalInfo'];
    }

    /**
     * Sets sellerLegalInfo
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\SellerLegalInfo|null $sellerLegalInfo sellerLegalInfo
     *
     * @return $this
     */
    public function setSellerLegalInfo($sellerLegalInfo)
    {
        $this->container['sellerLegalInfo'] = $sellerLegalInfo;
