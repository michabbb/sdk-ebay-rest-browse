...
class ShippingOptionSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $shippingCostType Indicates the type of shipping used to ship the item. Possible values are <code> FIXED</code> (flat-rate shipping) and <code> CALCULATED</code> (shipping cost calculated based on item and buyer location).
     *
     * @return self
     */
