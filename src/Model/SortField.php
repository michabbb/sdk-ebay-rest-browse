 ...
 *
 * @category Class
 * @description The type that defines the fields that control how items in result sets are sorted.
 * @package  macropage\SDKs\ebay\rest\browse
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SortField implements ModelInterface, ArrayAccess
{
     ...
     * Sets ascending
     *
     * @param bool|null $ascending Indicates if the results are sorted in ascending (smallest to greatest) order.
     *
     * @return $this
     */
     ...
     * Sets field
     *
     * @param string|null $field Specifies the name of a field in which to sort items using the value of that field. For example, if the field name was amount, the items would be sorted by the amount, or cost of the item.
     *
     * @return $this
     */
