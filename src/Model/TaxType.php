 ...
 *
 * @category Class
 * @description An enumerated type for the values that represent the type of tax. Code so that your app gracefully handles any future changes to this list.
 * @package  macropage\SDKs\ebay\rest\browse
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class TaxType
{
     ...
     */
    const STATE_SALES_TAX = 'STATE_SALES_TAX';
    const VAT = 'VAT';
    const PROVINCE_SALES_TAX = 'PROVINCE_SALES_TAX';
    const REGION = 'REGION';
