...
class Taxes implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'taxType' => '\macropage\SDKs\ebay\rest\browse\Model\TaxType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['includedInPrice'] = isset($data['includedInPrice']) ? $data['includedInPrice'] : null;
        $this->container['shippingAndHandlingTaxed'] = isset($data['shippingAndHandlingTaxed']) ? $data['shippingAndHandlingTaxed'] : null;
        $this->container['taxJurisdiction'] = isset($data['taxJurisdiction']) ? $data['taxJurisdiction'] : null;
     ...
     *
     * @param bool|null $ebayCollectAndRemitTax This field is only returned if true, and indicates that eBay will collect tax (sales tax, Goods and Services tax, or VAT) for at least one line item in the order, and remit the tax to the taxing authority of the buyer's residence.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $includedInPrice Indicates if tax was applied for the cost of the item.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $shippingAndHandlingTaxed Indicates if tax is applied for the shipping cost.
     *
     * @return $this
     */
     ...
     * Gets taxType
     *
     * @return \macropage\SDKs\ebay\rest\browse\Model\TaxType|null
     */
     ...
     * Sets taxType
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\TaxType|null $taxType taxType
     *
     * @return $this
     */
