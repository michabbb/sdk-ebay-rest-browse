 ...
 * @link     https://openapi-generator.tech
 */
class UpdateCartItemInput implements ModelInterface, ArrayAccess
{
     ...
     * Sets cartItemId
     *
     * @param string|null $cartItemId The identifier of the item in the cart to be updated. This ID is generated when the item was added to the cart.
     *
     * @return $this
     */
