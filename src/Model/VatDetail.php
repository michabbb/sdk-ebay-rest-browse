...
class VatDetail implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'issuingCountry' => '\macropage\SDKs\ebay\rest\browse\Model\CountryCodeEnum',
        'vatId' => 'string'
    ];
     ...
     * Sets issuingCountry
     *
     * @param \macropage\SDKs\ebay\rest\browse\Model\CountryCodeEnum|null $issuingCountry issuingCountry
     *
     * @return $this
     */
     ...
     * Sets vatId
     *
     * @param string|null $vatId The seller's VAT (value added tax) ID. VAT is a tax added by some European countries.
     *
     * @return $this
     */
