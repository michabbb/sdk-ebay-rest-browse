...
/**
 * AvailabilityStatusEnumTest Class Doc Comment
 *
 * @category    Class
 * @description An enumerated type for the values that represent the inventory status of an item.
 * @package     macropage\SDKs\ebay\rest\browse
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class AvailabilityStatusEnumTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testAvailabilityStatusEnum()
    {
    }
}
