...
/**
 * AvailabilityThresholdEnumTest Class Doc Comment
 *
 * @category    Class
 * @description An enumerated type for the values that represent the availability of an item based on a quantity threshold set by the seller. Code so that your app gracefully handles any future changes to this list.
 * @package     macropage\SDKs\ebay\rest\browse
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class AvailabilityThresholdEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "AvailabilityThresholdEnum"
     */
    public function testAvailabilityThresholdEnum()
    {
    }
}
