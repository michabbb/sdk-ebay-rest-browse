...
/**
 * CompatibilityStatusTest Class Doc Comment
 *
 * @category    Class
 * @description An enumerated type for the values that represent if an item is compatible with the specified product.
 * @package     macropage\SDKs\ebay\rest\browse
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class CompatibilityStatusTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testCompatibilityStatus()
    {
    }
}
